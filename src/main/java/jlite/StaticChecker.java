...
public class StaticChecker {
    ...
    private ArrayList<SemanticException> checkClass(Ast.Clas clas) {
        ArrayList<SemanticException> errors = new ArrayList<>();
        Env env = new Env(validClassNames);
    ...
    private ArrayList<SemanticException> checkMdDecl(Ast.MdDecl mdDecl, Env parent) {
        ArrayList<SemanticException> errors = new ArrayList<>();
        Env env = new Env(parent, validClassNames); // We create a new environment for the method
    ...
    private Ast.Typ checkStmt(Ast.Stmt stmt, Env env) throws SemanticErrors {
        ...
        if (stmt instanceof Ast.IfStmt) {
            ...
            try {
                ...
                if (!condTyp.equals(new Ast.Typ(Ast.JliteTyp.BOOLEAN))) {
                    errors.add(new SemanticException(String.format("%s not assignable to boolean for cond", cond.toString())));
                }
        ...
        return new Ast.Typ(Ast.JliteTyp.VOID);
    }

    private Ast.Typ doExpr(Ast.Expr cond, Env env) throws SemanticException {
